...
(function () {
  ...
  function renderHead() {
    ...
    $head.innerHTML = `
      <div class="staff-brand"><img src="/borani-table-ordering/img/logo.jpg" alt="" /> ${esc(t('reception'))}</div>
      <nav class="r-tabs">
    ...
    $main.innerHTML = `
      <div class="r-panel">
        ...
        <form class="r-qr-controls" data-table-count>
          ...
          <a class="btn btn-primary" href="/borani-table-ordering/qr/" target="_blank" rel="noopener">${icon('printer', 22)} ${esc(t('print_qr'))}</a>
        </form>
        <div class="r-qr-grid">
          ${
            qrList
